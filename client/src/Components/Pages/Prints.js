...
import { PrintProducts } from "../DataFiles/PrintProducts";
        ...
        <Row className="my-2">
          {PrintProducts.map((product) => (
            <Col lg="3" md="4" sm="6" xs="12" className="mt-4">
              <Card
                className="border-0 rounded-0 myCard"
                key={product.id}
              ...
              >
                ...
                <Card.Body className="p-0">
                  <Card.Title className="mt-3 text-capitalize fs-6">
                    {product.title}
                  </Card.Title>
                  <Card.Title className="mt-2 text-capitalize fw-light fs-6">
                    {product.completeSuitPrice}
                  </Card.Title>
                </Card.Body>
              </Card>
            </Col>
